  ...
  return (
    <div className="md:flex justify-center">
      ...
      <div className="w-full mt-10">
        <h1 className="text-4xl font-bold my-10">ব্যাংক জব প্রস্তুতি</h1>
        <p className="text-lg">
        ...
        <div className="md:flex mt-5">
          <div className=" my-10">
            ...
            <p className="text-6xl font-black text-indigo-700">55</p>
          </div>
          <div className="md:mx-20 my-10">
            <h2 className="text-xl font-bold my-5">Total Hours Of Video</h2>
            <p className="text-6xl font-black text-indigo-700">40</p>
          </div>
          <div className=" my-10">
            <h2 className="text-xl font-bold my-5">Total PDF</h2>
            <p className="text-6xl font-black text-indigo-700">21</p>
          </div>
        </div>
      </div>
    </div>
